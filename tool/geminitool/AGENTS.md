...
> Implements concrete tool definitions for integrating external capabilities, such as Google Search, into Large Language Model requests. It provides a wrapper for Gemini API tool definitions and utilities for managing their configuration within LLM interactions.
