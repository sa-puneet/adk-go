...
> Provides a specialized tool designed to signal an agent's immediate exit from a processing loop. Implements a factory function for tool creation and includes comprehensive tests to ensure correct termination behavior.
