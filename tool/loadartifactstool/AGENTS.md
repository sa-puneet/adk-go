...
**Parent**: [tool](../AGENTS.md) | **Repository**: An open-source, code-first

> Implements a specialized tool for Large Language Models, enabling them to access and integrate external artifacts into their processing. It defines the tool's interface, handles artifact loading requests, and formats the retrieved data for consumption by generative AI models.
