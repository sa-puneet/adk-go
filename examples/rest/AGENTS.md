...
**Parent**: [examples](../AGENTS.md) | **Repository**: An open-source, code-first Go toolkit for

> Provides the main application entry point, orchestrating the initialization of an AI agent powered by the Gemini model with Google Search capabilities. It configures and starts an HTTP server to expose this agent as a REST API, including a health check endpoint.
